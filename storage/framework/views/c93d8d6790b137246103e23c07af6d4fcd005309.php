...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><b>Fanwe</b>方维</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">登录你的管理员账户</p>

        <form action="<?php echo e(URL::to('/doLogin')); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
            <div class="form-group has-feedback">
                <input type="text" name="adm_name" class="form-control" placeholder="账户">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
            <div class="form-group has-feedback">
                <input type="password" name="adm_password" class="form-control" placeholder="密码">
